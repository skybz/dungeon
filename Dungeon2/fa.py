...
def copeb(round,me,enemy):
    if enemy.name=='slime_king':
        if round%3==1:
            ...
            return (int)(enemy.attack*1.5-me.defense)
        if round%3==2:
            print('slime_king decided to hit you many times')
            return (int)((enemy.attack-me.defense)*2)
        if round%3==0:
            print('slime_king choose to use its ulimate hit')
            return (int)(enemy.attack*2.05-me.defense)
    print('%s decided to hit you'%enemy.name)
    if enemy.name=='bird':
        if round%2==1:
            print('bird decided to hit you many times')
            return (int)((enemy.attack-me.defense)*10)
        if round%2==0:
            print('bird was angry he decided to hit you heavily')
            return (int)(enemy.attack*4)-me.defense
    return (int)(enemy.attack-me.defense)

def summonmap():
    map=[6,0,0,0,0,0,0,6,7]
    vis=[0,0,0,0,0,0]
    for i in range(6):
